exports.run = {
   ...
   async: async (m, { client, isPrefix, command, Func }) => {
      try {
         ...
         const messageContent = `▎🛍️ *PEMBELIAN CANVA*
━━━━━━━━━━━━━━━━━━
*DETAIL PEMBELIAN*

*Jenis Akun* : _CANVA INVITE_
*Durasi* : _30 HARI_
...
*KIRIM BUKTI TRANSFER DI DALAM CHAT*`;
         ...
         const forwardMessage = `*Customer Menjalankan Perintah pembelian Canva 1B*\n*Nomor* : _${nomorPengirim}_`;
